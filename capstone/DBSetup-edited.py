...
def create_and_setup_db():
    ...
    if conn is not None:
        execute_sql_command(conn,create_db)
        execute_sql_command(conn,use_db)
        execute_sql_command(conn,create_table_command2)
...
def import_file(filepath):
    ...
    for row in range(len(df_raw)):
        ...
        sql_query = """INSERT INTO WEB_RAW_DATA (Serial_number,document_id,URL,Credibility_rating, ad_count,ad_max_size,css_definitions,page_rank,bitly_clicks,bitly_referrers,tweets,delicious_bookmarks,fb_clicks,fb_comments,fb_likes,fb_shares,fb_total,alexa_linksin,alexa_rank,commas,dots,exclamations,questions,spelling_errors,text_complexity,smog,category,JJ,NN,DT,VB,RB,num_ne,sum_ne,document_url_y,X1,X2,X3,X4,X5,X9,Total,Leik,Eijk,Tastle,Leik_3_4_6,correction,resp_HNC,Controversial,troia_label) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"""
        cur.execute(sql_query,(li_serial_num, li_doc_id, ls_url, ld_credibility_rating,ld_ad_count,ld_ad_max_size,ld_css_definitions,ld_page_rank,ld_bitly_clicks,ld_bitly_referrers,ld_tweets,ld_delicious_bookmarks,ld_fb_clicks,ld_fb_comments,ld_fb_likes,ld_fb_shares,ld_fb_total,ld_alexa_linksin,ld_alexa_rank,ld_commas,ld_dots,ld_exclamations,ld_questions,ld_spelling_errors,ld_text_complexity,ld_smog,ls_category,ld_JJ,ld_NN,ld_DT,ld_VB,ld_RB,ld_num_ne,ld_sum_ne,ls_document_url_y,ld_X1,ld_X2,ld_X3,ld_X4,ld_X5,ld_X9,ld_Total,ld_Leik,ld_Eijk,ld_Tastle,ld_Leik_3_4_6,ld_correction,ls_resp_HNC,ls_Controversial,ld_troia_label))
...
if __name__ =="__main__":
    ...
    print(import_file("./data/web_trust.csv"))
